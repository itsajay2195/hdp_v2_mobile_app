...
def get_desired_capabilities(app):
    return dict(platformName='Android', deviceName='emulator-5554',
                app=PATH('../../../apps/' + app), appPackage='com.happyfox.helpdesk',
                appWaitActivity='com.happyfox.helpdesk.MainActivity', newCommandTimeout=240)
